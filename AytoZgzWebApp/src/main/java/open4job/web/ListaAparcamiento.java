...
public class ListaAparcamiento extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ListaAparcamiento() {
		super();
	...
	protected void doGet(HttpServletRequest request,
		...
		//AparcamientoMotoDAO aparcamientoMotoDAO = new AparcamientoMotoDAO(driver, url, user, password);
